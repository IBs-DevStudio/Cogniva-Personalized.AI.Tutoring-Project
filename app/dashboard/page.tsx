    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setRecentSessionsCompanions(
          fetchedRecentSessions?.length ? fetchedRecentSessions : [],
        );
      } catch {
        setRecentSessionsCompanions([]);
      }
  ...
  return (
    <main>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold">Featured Companions</h1>
      ...
      <section className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-6 sm:gap-8 items-start mt-8">
        <div>
            ...
            <div className="w-full">
              ...
              <div className="bg-gray-50 rounded-lg p-8 text-center">
                <p className="text-gray-600">
                  No sessions completed yet. Start a session with any companion

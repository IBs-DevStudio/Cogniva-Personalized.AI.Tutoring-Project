...
const DEMO_EMAIL = "demo.cogniva@gmail.com";
const DEMO_PASSWORD = "Cogniva.Demo@1234!";
        ...
        <div className="w-full rounded-xl border border-border bg-card px-4 py-3 flex items-center justify-between gap-3">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              Use a ready-made demo account (for recruiters or reviewers) to
              quickly explore Cogniva&apos;s primary features.
            </p>
          </div>
          <Button
            size="sm"
        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-xl border border-border bg-card shadow-lg p-5 space-y-4 relative">
            ...
            <div className="space-y-1 pr-10">
              ...
              <p className="text-xs text-muted-foreground">
                This shared demo account is for recruiters, reviewers, or anyone
                who just wants to see how Cogniva&apos;s main flows work without
            ...
            <div className="space-y-1 text-[11px] leading-relaxed text-muted-foreground">
              <p className="font-semibold text-foreground">
                Important: demo account has limited access
              </p>
              <ul className="list-disc list-inside space-y-0.5">
                <li>
                  Some flows and actions are shortened so you can quickly see
                  how Cogniva&apos;s AI companions work.
                </li>
                <li>Usage is capped to keep the demo stable for everyone.</li>
                <li>
                  For a full experience later, you can sign up with your own
                  email or phone and unlock all features.
                </li>
              </ul>
            </div>
          </div>
